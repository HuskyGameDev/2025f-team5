...
static func new_enemy(_sprite = null, health: float = 5.0, speed: int = 10, firerate: float = 2.0, damage: float = 1.0, shot_speed: int = 0, bullet_lifetime: float = 4.0) -> CharacterBody2D:
